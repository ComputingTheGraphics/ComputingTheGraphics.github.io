...
function createPostsMenu() {
    ...
    text = readFileInJS(
        "https://www.computingthegraphics.com/posts/_auto_generated_posts_menu.txt");
    ...
    for (line in fileLines) {
        ...
        if (line.startswith('=')) { continue; } // autogenerated warning
            ...
            folderString.replace("TITLE", line);
        } else {
            // file - these line start with tabs.
            var individualPost = "" + postFormat;
            individualPost.replace("POST_TITLE", line);
